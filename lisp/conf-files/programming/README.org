...
(use-package dockerfile-mode
  :hook
  ((dockerfile-mode dockerfile-ts-mode) . lsp-deferred)
  :defer 5
  )
#+end_src
...
(use-package treesit
  ...
  :config
  (let ((tree-langs '(janet-simple python clojure typescript tsx make css html json vue bash hyprlang  cmake make  qmljs)))
