...
- [[#awesome][Awesome]]
- [[#char-menu][Char-menu]]
- [[#inhibit-mouse-test][Inhibit-Mouse (test)]]
...
(use-package easysession
  ...
  (leader-key
    ...
    "TAB s" '(easysession-save :wk "Save")
    "TAB d" '(easysession-delete :wk "Delete")
    "TAB r" '(easysession-rename :wk "Rename")
    "TAB R" '(easysession-reset :wk "Reset")
    "TAB S" '(easysession-save-session-and-close-frames :wk "Save/Close frames")
    "TAB u" '(easysession-unload :wk "Unload"))
  (add-hook 'easysession-new-session-hook #'easysession-reset)
  
  (defun my/easysession-no-main-saved ()
    "Only save the main session."
    (when (not (string= "main" (easysession-get-current-session-name)))
      t))
  (setq easysession-save-mode-predicate 'my/easysession-no-main-saved)
...
(use-package flycheck
  ...
  (setq-default flycheck-disabled-checkers
		        (append flycheck-disabled-checkers
			            '(javascript-jshint json-jsonlist ;; org-lint
                                            emacs-lisp-checkdoc)))
...
(use-package yasnippet-capf
  ...
  :hook
  ((LaTeX-mode org-mode bibtex-mode) . my/yasnippet-capf-h))
#+end_src
* Drag-stuff
:PROPERTIES:
...
(use-package casual ;; A collection of  user interfaces for various built-in Emacs modes.
  ...
  (:states 'normal :keymaps 'bibtex-mode-map "C-o" 'casual-bibtex-tmenu)
  (:states 'normal :keymaps 'cmake-mode-map "C-o" 'casual-make-tmenu)
  (:states 'normal :keymaps 'css-mode-map "C-o" 'casual-css-tmenu)
  (:states 'normal :keymaps 'html-mode-map "C-o" 'casual-html-tmenu)
...
(use-package string-inflection
  ...
  (:keymaps '(python-mode-map python-ts-mode-map)
            :prefix "C-c"
            "C-u" 'string-inflection-python-style-cycle))
#+end_src

#+RESULTS:
: [nil 26904 10820 761773 nil elpaca-process-queues nil nil 168000 nil]
...
(use-package use-proxy
  :commands (my/toggle-tmenu)
  :custom
  (use-proxy-http-proxy "localhost:2080")
  (use-proxy-https-proxy "localhost:2080"))
#+end_src

#+RESULTS:
: [nil 26913 62282 537977 nil elpaca-process-queues nil nil 44000 nil]
...
#+RESULTS:
: [nil 27250 8062 543470 nil elpaca-process-queues nil nil 691000 nil]

* Inhibit-Mouse (test)
:PROPERTIES:
:CUSTOM_ID: inhibit-mouse-test
:END:
#+begin_src emacs-lisp
(use-package inhibit-mouse
  ...
  (inhibit-mouse-misc-events '("wheel-left" "wheel-right" "pinch"))
  :init
  (if (daemonp)
