...
(use-package org-roam
  ...
  (setq org-roam-capture-templates
        '(
          ...
          ;; Black Crusade
          ("rb" "Black Crusade")
          ("rbb" "Character Sheet" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/char_sheet.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Character:\n#+date: %U")
           :unnarrowed t)
          ("rba" "Armor" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/armor.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Armor:Equipment:\n#+date: %U")
           :unnarrowed t)
          ("rbA" "Armor Traits" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/armor_traits.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Armor:Traits:\n#+date: %U")
           :unnarrowed t)
          ("rbc" "Clothes" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/clothes.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Clothes:\n#+date: %U")
           :unnarrowed t)
          ("rbC" "Consumable" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/consumables.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Consumables:Equipment:\n#+date: %U")
           :unnarrowed t)
          ("rbg" "Gift of Gods" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/gift_of_gods.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Gifts:\n#+date: %U")
           :unnarrowed t)
          ("rbi" "Implant" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/implants.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Implant:Equipment:\n#+date: %U")
           :unnarrowed t)
          ("rbp" "Power_Field" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/power_field.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Armor:Power_Field:Equipment:\n#+date: %U")
           :unnarrowed t)
          ("rbP" "Psychic Power" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/psychic_powers.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Psychic_Powers:\n#+date: %U")
           :unnarrowed t)
          ("rbr" "Reward of Gods" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/rewards_of_gods.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Rewards:\n#+date: %U")
           :unnarrowed t)
          ("rbt" "Talent" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/talent.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Talent:\n#+date: %U")
           :unnarrowed t)
          ("rbT" "Trait" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/traits.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Trait:\n#+date: %U")
           :unnarrowed t)
          ("rbe" "Tool" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/tools.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Tool:Equipment:\n#+date: %U")
           :unnarrowed t)
          ("rbw" "Weapon" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/weapons.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Weapon:Equipment:\n#+date: %U")
           :unnarrowed t)
          ("rbW" "Weapon Trait" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/weapon_traits.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Weapon_Trait:\n#+date: %U")
           :unnarrowed t)
          ("rbE" "Wargear" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/wargear.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Wargear:Equipment:\n#+date: %U")
           :unnarrowed t)
          ("rbm" "Ammunition" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/ammunition.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Weapon:Ammunition:Equipment:\n#+date: %U")
           :unnarrowed t)
          ("rbs" "Special Abilities" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/special_abilities.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Special_Abilities:\n#+date: %U")
           :unnarrowed t)
          )         
        )
