...
(use-package evedel
  ...
  (general-define-key
   ...
   :prefix "C-e"
   "" '(:ignore t :wk "Evedel")
   "D" '(evedel-delete-all-instructions :wk "Delete All")

   ;; Instructions
   "i" '(:ignore t :wk "Instructions")
   "i n" '(evedel-next-instruction :wk "Next")
   "i p" '(evedel-previous-instruction :wk "Previous")
   "i d" '(evedel-delete-instructions :wk "Delete (point/region)")
   "i s" '(evedel-save-instructions :wk "Save")
   "i l" '(evedel-load-instructions :wk "Load")

   ;; Directives
   "d" '(:ignore t :wk "Directive")
   "d c" '(evedel-create-directive :wk "Create")
   "d n" '(evedel-next-directive :wk "Next")
   "d p" '(evedel-previous-directive :wk "Previous")
   "d m" '(evedel-modify-directive :wk "Modify")

   ;; References
   "r" '(:ignore t :wk "References")
   "r n" '(evedel-next-reference :wk "Next")
   "r p" '(evedel-previous-reference :wk "Previous")
   "r c" '(evedel-create-reference :wk "Create")
   "r m" '(evedel-modify-reference-commentary :wk "Modify commentary")
   
   ;; Tags
   "t" '(:ignore t :wk "Tags")
   "t a" '(evedel-add-tags :wk "Add")
   "t d" '(evedel-remove-tags :wk "Delete")
   "t q" '(evedel-modify-directive-tag-query :wk "Query")

   ;; Prompt
   "p" '(:ignore t :wk "Prompt")
   "p p" '(evedel-process-directives :wk "Send")
   "p P" '(evedel-preview-directive-prompt :wk "Preview")
   ))
#+end_src
...
(use-package consult-omni
  ...
  (setq consult-omni-sources-modules-to-load '(consult-omni-gptel consult-omni-apps consult-omni-fd consult-omni-elfeed consult-omni-ripgrep consult-omni-ripgrep-all consult-omni-git-grep))
