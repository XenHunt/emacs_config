...
(use-package org
  ...
  :general
  (:states 'normal "SPC a a" 'org-agenda)
  :hook
  (org-mode . (lambda ()
...
(after! org
  ...
  (general-define-key
   ...
   ;; Wide tables workflow
   "m b m" 'org-mark-element
   "m b w" 'org-table-wrap-region
   "m b T" 'org-table-transpose-table-at-point
   "m b t t" 'toggle-truncate-lines
