  ...
  (setq org-roam-capture-templates
        '(
          ...
          ("c" "DH2 Char" plain
           ...
           :if-new (file+head "%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+category: RPG, DH2, Character Sheet\n#+date: %U")
           :unnarrowed t)
...
(add-to-list 'org-latex-packages-alist '("" "babel" t))
...
(general-define-key
 ...
 ;; Chatu
 "m c" '(consult-chatu-new :wk "consult-chatu-new")
 )
