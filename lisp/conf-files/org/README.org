  ...
  (setq org-roam-capture-templates
        '(
          ...
          ("rbT" "Trait" plain
           ...
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Traits:\n#+date: %U")
           :unnarrowed t)
          ("rbe" "Tool" plain
           (file "~/.org/roam/templates/tabletop/BlackCrusade/tools.org")
           :if-new (file+head "tabletop/BlackCrusade/%<%Y-%m-%d-%H:%M:%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :Black_Crusade:Tools:Equipment:\n#+date: %U")
           :unnarrowed t)
          ("rbw" "Weapon" plain
...
(use-package chatu
  ...
  (chatu-mode . (lambda ()
                  (setq-local chatu-input-dir (get-cache-path "draws"))
                  (setq-local chatu-output-dir (get-cache-path "images"))))
  :commands (chatu-add
             chatu-open))
...
(use-package org-download
  ...
  :hook ((org-mode dired-mode) . (lambda ()
            (setq-local org-download-image-dir (get-cache-path "images"))))
  :config
...
(general-define-key
 ...
 "m a t l" 'org-transclusion-make-live-sync-start
 "m a t L" 'org-transclusion-make-live-sync-exit
 ...
 "m c o" 'org-clock-out
 "m c r" 'org-clock-resolve-clocks
